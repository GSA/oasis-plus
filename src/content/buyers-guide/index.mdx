...
OASIS+ is ready to meet your agency’s complex, integrated multiple service requirements. The Buyer’s Ordering Guide is designed to make buying a smooth, streamlined process, with resources for every part of your journey. Explore the guide below or view the [OASIS+ Buyers’ Ordering Guide (printable)](/ordering-guide/).
...
<ContentList>
    <ContentListItem header="Acquisition planning" img_src="images/buyers/acq-planning-image.svg" img_alt="Two people examining a diagram.">
        ...
        ### Get a scope review (content coming soon)
    ...
    <ContentListItem header="Market research (content coming soon)" img_src="images/buyers/market-research-image.svg" img_alt="Person drawing a chart showing data.">
    ...
    <ContentListItem header="Prepare to develop your solicitation" img_src="images/buyers/prepare-solicitation-image.svg" img_alt="Person surrounded by text bubbles.">
        ...
        In order to solicit and place task orders under OASIS+, the ordering contracting officer or OCO must obtain a Delegation of Procurement Authority (DPA).
    ...
    <ContentListItem header="Develop and issue the solicitation (content coming soon)" img_src="images/buyers/develop-solicitation-image.svg" img_alt="Person working on a laptop while drawing on a tablet.">
    ...
    <ContentListItem header="Award and manage the task order in Symphony (content coming soon)" img_src="images/buyers/award-task-order-image.svg" img_alt="Person standing in front of a monitor and pointing to an arrow.">
...
<SummaryBox header="Can’t find what you’re looking for?">
    ...
    - [OASIS+ Buyers' Ordering Guide (printable)](/ordering-guide/)
    - [Resources](/resources/)
