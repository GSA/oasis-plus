...
There are several unique CALC+ tools available on [buy.gsa.gov](https://buy.gsa.gov/pricing/) to support government acquisition professionals in finding awarded prices to use in negotiations for labor contracts. CALC+ offers ceiling prices, fully burdened costs, services data, and worldwide rates to help with services pricing business intelligence.

### CALC+ Tools Guidance 
- When evaluating CALC+ pricing, including BLS QR, OCOs must exercise independent business judgment consistent with their authority, while remaining compliant with all applicable regulations and guidance. Plain language
...
- CALC+ BLS allows users to:
    ...
    * Pair your estimated rate from the BLS tool with prices paid data on [buy.gsa.gov](http://buy.gsa.gov/) to improve your price analysis and overall estimated cost
    * Be sure to review the [User Guide](https://buy.gsa.gov/pricing/assets/documents/user-guides/CALC+%20User%20Guide%20for%20BLS%20Rates_V1.0.pdf) for helpful information.
...
- CALC+ Prices Paid data is based on the contractor invoice data uploaded to GSA’sContractor Payment Reporting Module (CPRM). Prices Paid are actual invoiced labor rates paid by federal agencies on awarded task/delivery orders for Time and Material (T&M) and Labor Hour (LH) contract line item numbers (CLINs). 
...
- CALC+ Prices Paid data includes invoices reported in the CPRM for the following contract programs:
    ...
    * OASIS
    * HCaTS
- IMPORTANT: This tool is being introduced as a minimally viable product. New features and enhancements will be added in the future. Users are encouraged to submit feedback and enhancement requests by completing the form displayed on the Prices Paid tool.
- Be sure to review the [User Guide](https://buy.gsa.gov/pricing/assets/documents/user-guides/CALC+%20QR%20Prices%20Paid%20User%20Guide_Version%201.0.pdf) for helpful information.

## Research agencies and sellers

We offer a variety of resources to help research the federal market. Check out [Research agencies and sellers] (/buyers-guide/research-agencies-sellers)

## Get a scope review (optional)

OASIS+ contract holders may request an optional and complimentary scope review via [OASIS+ Scope Review](https://feedback.gsa.gov/jfe/form/SV_6s3udkBbX9z1zee). The scope review is completed by GSA and will ensure the requirement is being placed under the appropriate OASIS+ contract; having the appropriate contract will help best meet your requirements.
...
MRAS is a free service and can be requested after completing an optional [OASIS+ Scope Review](https://feedback.gsa.gov/jfe/form/SV_6s3udkBbX9z1zee). Contact your [local GSA Customer Service Director](http://gsa.gov/csd)) for assistance with MRAS.

### How do I initiate an MRAS request?

- [Request for Information (RFI) with Market Research Report](https://feedback.gsa.gov/jfe/form/SV_2cA12XMJvIWfR9Y) - request an RFI to understand GSA contracts and industry capabilities with a market 

### Learn more about MRAS

- Market Research as a Service Overview (video)
- Market Research as a Service

## Send an RFI
You can send an RFI to OASIS+ contract holders and their capabilities within each OASIS+ contract, Domain, and NAICS code using [Symphony](https://oasis.app.cloud.gov/).