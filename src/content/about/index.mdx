...
One Acquisition Solution for Integrated Services Plus or OASIS+ is a suite of governmentwide, multi-award contracts designed to support federal agencies’ procurement requirements for services-based solutions. 

## A streamlined program with expanded offerings

This suite of contracts combines the scope of legacy OASIS, Building, Maintenance, and
Operations and Human Capital and Training Solutions, under one program, along with new areas of service that were previously not in scope. It expands the range of service offerings for buyers and gives sellers a greater variety of areas they can compete for.
...
<GradientBox callout_url="about/oasis-plus-comparison/" callout_text="Learn more about how OASIS+ compares to OASIS legacy">
### Key features
    <IconList>
