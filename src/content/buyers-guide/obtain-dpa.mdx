...
A delegation of procurement authority (DPA) is a written authority to issue an order under the master contract; it clearly outlines the roles and responsibilities between the GSA OASIS+ contracting officer and the ordering contracting officer.
...
DPA training is strongly encouraged for any staff (Program Manager, Contract Specialist, Finance, Interns, etc.) interested in and/or administering an OASIS+ requirement. The training is **required** for any staff to post a solicitation in Symphony; however, only a warranted CO may obtain the DPA.
...
<IconList>
  <CheckListItem icon="cancel" color="text-red">
    ...
    solicitation system (Symphony) to conduct market research, which includes issuing RFIs.
  </CheckListItem>
  <CheckListItem icon="cancel" color="text-red">
