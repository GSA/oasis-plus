...
One Acquisition Solution for Integrated Services Plus is a suite of government-wide, multi-award contracts designed to support federal agencies’ procurement requirements for services-based solutions. 
...
### Key features
    <IconList>
        ...
        <CheckListItem>10-Year Order Period (Base of 5 + One 5 Year Option Period)</CheckListItem>
    ...
    <div class="text-center">
        <a class="usa-button usa-button--outline bg-white margin-3">Learn more about how OASIS+ compares to OASIS</a>
    </div>
