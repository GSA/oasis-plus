...
The contract scope of OASIS+ is organized by [domains](/about/domains-naicscodes-scope-labor-categories/), which are functional groupings of related services spanning multiple NAICS codes. Domains are designed to align order requirements to qualified industry partners. Each domain is limited to the [NAICS codes](/about/domains-naicscodes-scope-labor-categories/naics-codes/) and associated size standards specifically listed under that domain.
...
- A contractor must be a current 8(a) participant at the time of task order award in order to receive a Sole Source (Direct) order. The OCO should check the 8(a) status at [SBA Dynamic Search](https://www.sba.gov/partners/contracting-officials/small-business-procurement) before considering a Sole Source (Direct) order.
