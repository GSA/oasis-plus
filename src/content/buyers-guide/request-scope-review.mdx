...
1. Complete the [OASIS+ Scope Review Online form](https://feedback.gsa.gov/jfe/form/SV_6s3udkBbX9z1zee). In addition to the free and complementary scope review, we can provide [Market Research as a Service (MRaS)](/buyers-guide/complete-market-research/) upon request.
