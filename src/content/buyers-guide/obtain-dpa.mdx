...
<ProcessList>
    ...
    <ProcessListItem>
        **Attend a DPA training.**
        ...
        Training is currently under development. It will be available online, virtually, and in-person; visit this page and [OASIS+ Interact Community](https://buy.gsa.gov/interact/community/196) for updates.
    </ProcessListItem>
    <ProcessListItem>
