...
| --------------------------| --------------------------| --------------------------|
| # Scope | <ul> <li> Scope is professional services.</li> <li> - Organized by size standard into pools of unrelated NAICS codes. </li> </ul> | -Scope is professional and other Service Contract Labor Standards (SCLS) covered services. -Organized by related services into domains of individual NAICS codes. |
| #Solicitation closing strategy and on-ramping processes | | | 
