...
<ContentList>
    ...
    <ContentListItem header="Award and manage the task order (coming soon)" img_src="images/buyers/award-task-order-image.svg" img_alt="Person standing in front of a monitor and pointing to an arrow.">
