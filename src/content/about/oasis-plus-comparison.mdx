...
| --------------------------| --------------------------| --------------------------|
| # Scope | -Scope is professional services. -Organized by size standard into pools of unrelated NAICS codes. | -Scope is professional and other Service Contract Labor Standards (SCLS) covered services. -Organized by related services into domains of individual NAICS codes. |
