...
OASIS+ will enable federal customers to acquire innovative solutions from highly qualified businesses on a contract vehicle designed to be best-in-class: a governmentwide designation that satisfies key criteria defined by Office of Management and Budget which allows sellers to offer an expanded variety of services.

- [Learn more about contract families](#)
