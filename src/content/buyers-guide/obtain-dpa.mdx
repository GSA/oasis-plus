...
<Alert heading="Training is currently under development.">
  Visit this page or the [OASIS+ Interact Community](https://buy.gsa.gov/interact/community/196/activity-feed) for updates.
</Alert>

A Delegation of Procurement Authority (DPA) is a written authority to issue an order under the master contract; its purpose is to clearly outline the roles and responsibilities between the GSA OASIS+ contracting officer and the ordering contracting officer.
...
<IconList>
  <CheckListItem icon="check_circle" color="text-green">
    If you are a contracting officer (CO) who plans to award, administer, and
...
DPA training is encouraged for any staff (Program Manager, Contract Specialist, Finance, Interns, etc.) interested in or administering an OASIS+ requirement; however, only a warranted Contracting Officer may obtain the DPA.
    ...
    <ProcessListItem>
     ...
     <ProcessListItem>
        **Request a DPA.**
        ...
        The DPA request form is under development. Please continue to check this page or the [OASIS+ Interact Community](https://buy.gsa.gov/interact/community/196/activity-feed) for updates.

        GSA will review your request, and you will receive a confirmation of the DPA via email within two business days. If you get a warrant after receiving training, you can request a DPA by emailing the respective program training at [oasisplusDPA@gsa.gov](mailto:oasisplusDPA@gsa.gov).
