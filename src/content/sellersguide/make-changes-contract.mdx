...
Note: Note: Please reference the OASIS+ Solicitation section, **G.3.1.7.1  Mergers, Acquisitions, Novations, And Change-of-Name Agreements,** for specific information on the process to request novations.
