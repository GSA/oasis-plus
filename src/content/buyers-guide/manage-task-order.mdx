...
The OCO should consider the following requirements and factors when managing task orders:

- [Reassigning task orders for administration](#reassigning-task-orders-for-administration)
- [Quality assurance – contractor surveillance](#quality-assurance--contractor-surveillance)
- [OASIS+ UR subcontracting plans](#oasis-ur-subcontracting-plans)
- [Performance evaluation](#performance-evaluation)
- [Task order closeout](#task-order-closeout)
