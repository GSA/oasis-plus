...
References: Please refer to section H.16.3 Marketing of the contracts, [GSAR 552.203-71, Restriction on Advertising](https://www.acquisition.gov/gsam/552.203-71) and the guidelines on this page for additional information.

Note of clarification: Per the OASIS+ contract, section H.16.3 Marketing, GSA reserves the right to review marketing, promotional materials or news releases by a Contractor that is OASIS+ related, including information on Contractor’s OASIS+ webpage. To clarify, it is not a requirement that GSA review and approve in advance and/or permission granted to awardees in advance of their use. If GSA observes any concerns with marketing materials, we will reach out to the respective contractor and engage individually. 
...
| OASIS+ Infographic | Provides bite-size content about the program and the six contracts. |

## OASIS+ logos
| Description | Image sample | Download |
| ------------| --------------|----------|
|OASIS+ master contract logos - come in three versions to allow flexibility around their use. Find the most suitable version for your specific use.|![Sample image of oasis+ master logo](/files/logos/oasis-plus-master-logo-sample.png )| [Download ZIP file](/files/logos/oasis_plus_master_logos.zip)|
|OASIS+ family contract-specific logos - used to visually represent each one of the current eight domains to be used only as applicable to your specific contract(s).| ![Sample image of OASIS+ family contract specific logo](/files/logos/oasis-plus-family-contract-logos-sample.png )| [Download ZIP file](/files/logos/oasis_plus_family_contract_specific_logos.zip)|
