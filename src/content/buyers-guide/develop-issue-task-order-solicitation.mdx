...
Upon filling out the following template, please delete all instructional information in blue and any sections that do not apply. Also, this template format is not mandatory; however, the minimum information herein is necessary for a proper solicitation under OASIS.
