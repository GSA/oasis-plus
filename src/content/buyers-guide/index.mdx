...
<ContentList>
    ...
    <ContentListItem header="Market research" img_src="images/buyers/market-research-image.svg" img_alt="Person drawing a chart showing data.">
        ...
        In order to conduct RFIs, you must register in Symphony Procurement Suite.
    ...
    <ContentListItem header="Prepare to develop your solicitation" img_src="images/buyers/prepare-solicitation-image.svg" img_alt="Person surrounded by text bubbles.">
        ...
        ### [Get familiar with Symphony](resources/#proposal-submission-and-task-management)

        Check out our proposal submission and task management resources in preparation for developing your solicitation in Symphony Procurement Suite.
