...
|# Period of performance structure | Base of five years and one five-year option, with performance allowed on task orders for up to five years after master contract expiration.  <br/><br/> The end dates of the OASIS contracts are as follows: <br/>UR expires: March 1, 2025 SB and 8(a) expires: Dec. 19, 2024. | Base of five years and one five-year option. Task order PoP can extend up to five years and six months beyond the ordering period of the master contracts.|
