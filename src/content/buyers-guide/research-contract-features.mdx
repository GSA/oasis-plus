...
OASIS+ labor categories align to the Office of Management and Budget’s or OMB's Standard Occupational Classification Manual 2018, which includes compensation data maintained by the Department of Labor or DOL, Bureau of Labor Statistics or BLS. The Standard Occupational Classification or SOC system is a federal statistical standard used by federal agencies to classify workers into occupational categories for the purpose of collecting, calculating, or disseminating data.
