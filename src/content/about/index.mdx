...
Training is available to help you register, navigate, and use the tool; [check out Resources](/resources/) for a full list of trainings, or the Buyers’ Guide [Register in Symphony](/buyers-guide/register-in-symphony/), [Research contract features](/buyers-guide/research-contract-features), and Sellers’ Guide [Register in Symphony](/sellers-guide/register-in-symphony/) for more detailed information.
